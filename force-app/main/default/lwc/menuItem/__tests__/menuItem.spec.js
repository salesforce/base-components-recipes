...
describe('c-menu-item-checked', () => {
  ...
  it('should react to changes in checked attribute', () => {
    ...
    return Promise.resolve()
      .then(() => {
        expect(
          shadowQuerySelector(menuItem, 'a').getAttribute('aria-checked')
        ).toBe('true');
        expect(
          shadowQuerySelector(
            menuItem,
...
describe('c-menu-item-disabled', () => {
  ...
  it('should be disabled when its truthy', () => {
    ...
    return Promise.resolve().then(() => {
      const anchor = shadowQuerySelector(menuItem, 'a[aria-disabled=true]');
...
describe('href attribute', () => {
  ...
  it('if set should have a value matching the provided content', () => {
    ...
    return Promise.resolve().then(() => {
      expect(shadowQuerySelector(menuItem, 'a').getAttribute('href')).toBe(url);
    });
  });
});
