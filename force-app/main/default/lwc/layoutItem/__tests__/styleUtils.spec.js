...
describe('normalizeFlexibility', () => {
  it('should keep valid options', () => {
    ...
    expect(actual).toEqual(['auto', 'shrink', 'no-shrink', 'grow', 'no-grow']);
...
describe('computeLayoutClass', () => {
  it('should compute layout class', () => {
    ...
    expect(
      computeLayoutClass(layoutSize, flexibility, padding, 'left').toString()
    ).toBe(
  ...
  it('should compute layout class when missing flexibility and padding', () => {
    ...
    expect(computeLayoutClass(layoutSize).toString()).toBe('slds-size_7-of-12');
  });
