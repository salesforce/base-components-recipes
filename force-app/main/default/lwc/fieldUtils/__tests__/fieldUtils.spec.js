...
describe('getCompoundFields', () => {
  it('returns a list of component fields for Name', () => {
    const fields = getCompoundFields('Name', store.record, store.objectInfo);
...
describe('getUiField', () => {
  it('returns a map of values for compound fields', () => {
    const compoundField = getUiField('Name', store.record, store.objectInfo);
...
describe('reference utils', () => {
  it('gets the expected reference info', () => {
    const referenceInfo = getUiField('OwnerId', store.record, store.objectInfo);
