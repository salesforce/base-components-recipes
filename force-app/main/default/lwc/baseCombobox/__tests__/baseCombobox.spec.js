...
expect.extend({
  toBeFocused(actual) {
    ...
    return {
      message: () => `expected element to be ${pass ? 'NOT ' : ''}focused`,
      pass
    };
  },
...
describe('c-base-combobox', () => {
  ...
  describe('with empty items', () => {
    ...
    it('will close dropdown when items become empty', () => {
      ...
      return Promise.resolve()
        .then(() => {
          expect(shadowQuerySelector(element, '.slds-is-open')).not.toBe(null);
          element.items = [];
        })
        .then(() => {
          expect(shadowQuerySelector(element, '.slds-is-open')).toBe(null);
        });
    });
  });
  ...
  describe('with a pill', () => {
    ...
    it('renders a class name for the pill`s icon', () => {
      ...
      return Promise.resolve()
        .then(() => {
          expect(element).toHaveSelectors('.slds-input-has-icon_left-right');

          expect(element).not.toHaveSelectors('.slds-input-has-icon_right');
        })
        .then(() => {
          element.inputPill = {
        ...
        .then(() => {
          ...
          expect(element).toHaveSelectors('.slds-input-has-icon_right');
        });
    });
  });
  ...
  describe('is accessible', () => {
    ...
    it('should set ariaDescribedBy when inputDescribedByElements was passed as an invidual string', () => {
      ...
      return Promise.resolve().then(() => {
        expect(element.shadowRoot.querySelector('input').ariaDescribedBy).toBe(
          'element-id'
        );
      });
    });
  ...
  describe('with items', () => {
    ...
    it('renders correct amount of options, attaches ids', () => {
      ...
      return Promise.resolve().then(() => {
        ...
        expect((selectableItemsAmount * (selectableItemsAmount + 1)) / 2).toBe(
  ...
  describe('highlights properly', () => {
    it('highlights first option when drop down is opened', () => {
      ...
      return Promise.resolve().then(() => {
        ...
        const selectedItem = shadowQuerySelector(element, '.slds-has-focus');
    ...
    it('highlights an option defined in items when dropdown is opened', () => {
      ...
      return Promise.resolve().then(() => {
        ...
        expect(items.indexOf(selectedItem)).toBe(
          exampleData.exampleDataWithHighlightedCard.findIndex(e => e.highlight)
        );
      });
    });
  });
  ...
  describe('triggers events', () => {
    it('triggers select event when an option is selected', () => {
      ...
      input.click();
      return Promise.resolve().then(() => {
        shadowQuerySelector(element, 'lightning-base-combobox-item').click();
    ...
    it('triggers scroll when user scrolled', () => {
      ...
      return Promise.resolve()
        .then(() => {
          ...
          const listbox = shadowQuerySelector(element, '[role="listbox"]');
