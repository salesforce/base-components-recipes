...
const verifyDefaultNameValue = (element, resolve, reject) => {
  ...
  if (outputField) {
    try {
      ...
      expect(data.record.fields.Name.value).toEqual('Wicked Witch of the West');
    } catch (e) {
      reject(e);
    }
  } else {
...
describe('record view form', () => {
  it('wires recordUi to output fields', () => {
    ...
    return new Promise((resolve, reject) => {
      ...
      const form = shadowQuerySelector(element, 'lightning-record-view-form');
  ...
  it('wires added fields already included in record-ui', () => {
    ...
    return new Promise((resolve, reject) => {
      function loadHandler() {
        element.removeEventListener('load', loadHandler);
        element.addEventListener('load', () => {
          const includedField = shadowQuerySelector(element, '.includedField');
  ...
  it('wires added optional fields', () => {
    ...
    return new Promise((resolve, reject) => {
      function loadHandler(initialData) {
        const expectedFields = initialData.detail.objectInfos.Bad_Guy__c.fields;
        ...
        element.removeEventListener('load', loadHandler);
        element.addEventListener('load', () => {
          const excludedField = shadowQuerySelector(element, '.excludedField');
